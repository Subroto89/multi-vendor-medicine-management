...
const Sidebar = ({ isSideBarOpen, toggleMenu }) => {
  ...
  return (
    <div>
      <div
        className={`absolute w-56 md:w-64  inset-y-0 shadow-xl ${theme==="dark" ? "dark-bg border-r border-gray-600" : "bg-secondary"} flex flex-col gap-20 md:fixed   md:translate-x-0 transform ${
