  ...
  if (salesError || categorySalesError) {
    return (
      <div className="text-red-600 p-8 text-center bg-white shadow-md rounded-lg mx-auto max-w-4xl">
        ...
        {salesError && <p className="mt-1">Sales Summary: {salesError.message}</p>}
        {categorySalesError && <p className="mt-1">Category Sales: {categorySalesError.message}</p>}
        <button
          onClick={() => { refetchSales(); refetchCategorySales(); }}
  ...
  return (
    <div className=" px-4 bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-6 md:p-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4 text-center mt-8 md:mt-0">Admin Dashboard Overview</h1>
        ...
        <div className="bg-blue-50 p-6 rounded-lg shadow-md flex flex-col items-center justify-center min-h-[400px]">
          <h3 className="text-xl md:text-2xl font-semibold text-blue-800 mb-3">Sales Distribution by Medicine Category</h3>
